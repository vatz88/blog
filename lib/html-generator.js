module.exports = function (options) {
    ...
    let favicon = options.favicon ? `<link rel="icon" href="${options.favicon}">` : '<link rel="icon" href="../src/media/favicon.png">';

    const lang = options.lang || 'en';

    const dir = options.dir || 'lrt';

    let script = options.articles ? ["src/js/script.js"] : ["../src/js/script.js"];
    if (options.script) {
    ...
    let css = options.articles ? ["src/css/style.css"] : ["../src/css/style.css"];
    if (options.css) {
    ...
    let meta = options.meta ? (function (metaArr) {
        let arr = [];
